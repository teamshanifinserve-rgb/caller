...
app.post('/v1/audio/speech', async (req, res) => {
  ...
  try {
    const r = await fetch('https://api.sarvam.ai/text-to-speech', {
      ...
      body: JSON.stringify({ inputs: [input], target_language_code: 'hi-IN', speaker: 'anushka', model: 'bulbul:v2', pitch: 0, pace: 1.05, loudness: 1.0, enable_preprocessing: true, speech_sample_rate: 8000 })
    });
